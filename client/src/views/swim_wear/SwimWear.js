                  ...
                  <CTableRow className="text-center">
                    <CTableHeaderCell colSpan="2">
                      <CButton
                        ...
                        size="sm"
                        color={
                          candidate.some((candidateInfo) => candidateInfo.sw_status === 'locked')
                            ? 'success'
                            : 'primary'
                        }
                    ...
                    <CTableRow key={candidateInfo.number} className="text-center">
                      ...
                      <CTableDataCell>
                        <CFormInput
                          ...
                          value={
                            modifiedSwimWearCandidateScores[candidateInfo.id] !== undefined
                              ? modifiedSwimWearCandidateScores[candidateInfo.id]
                              : candidateInfo.sw_score || ''
                          }
                          onChange={(e) =>
                            handleScoreChange(
                              userInfo.id,
